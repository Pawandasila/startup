    ...
    >
      ...
      >
        <div className="flex justify-between items-start">
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wide text-text-muted mb-1">
              {product.brand}
            </h3>
          ...
          <div className="text-right">
            <span className="text-lg sm:text-xl font-sans tabular-nums font-bold">
              ${product.price}
              <span className="text-text-muted text-xs sm:text-sm font-normal ml-1">
        ...
        >
          ...
          <div className={isList ? "col-span-2" : ""}>
            <p className="text-xs text-text-muted uppercase tracking-widest font-bold mb-1">
              Status
            </p>
            <p
        ...
        {isList && (
          <p className="hidden sm:block mt-4 text-sm text-text-main/70 max-w-xl leading-relaxed">
            An exquisite piece from our {product.brand} collection. Perfect for
            statement-making occasions, featuring signature craftsmanship and
            exceptional materials. Expertly dry-cleaned and ready for your next
            event.
          </p>
        )}
